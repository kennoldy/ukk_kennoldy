...
<body>
									<div class="navigation">
										<ul class="navig">
											<li class="active"><a href="#"><i class="bag"></i><p class="active">Flights</p><div class="clear"></div></a></li>
											...
											<li class="nae"><a href="signup.php"><i class="button"></i><p>Sign Up</p><div class="clear"></div></a></li>
										</ul>
									</div>
							<h1>Kenn's Travel</h1>
						<div class="main">
